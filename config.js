// ======================================================
// COLORYMARMOL - CONFIGURACIÓN GENERAL
// ======================================================
...
window.COLORYMARMOL_DEFAULT_PRODUCTS = [

  {
    ...
    description:
      "Cocina de estilo moderno con gabinetes oscuros, detalles en madera y cubierta de cuarzo.",
...

  {
    ...
    description:
      "Diseño luminoso con isla central, cubierta clara y almacenamiento amplio.",
...

  {
    ...
    material: "MDF + piedra",
    description:
      "Diseño limpio, frentes continuos y herrajes discretos.",
...

  {
    ...
    description:
      "Vestidor abierto con organización personalizada y acabados premium.",
...

  {
    ...
    description:
      "Diseño contemporáneo con cajones, entrepaños y áreas de colgado.",
...

  {
    ...
    description:
      "Mueble suspendido moderno con almacenamiento y cubierta elegante.",
...

  {
    ...
    description:
      "Mueble a medida con encimera de mármol y apariencia premium.",
...

  {
    ...
    material: "Mármol",
    description:
      "Veta suave y elegante para cocinas, baños, barras y cubiertas.",
...

  {
    ...
    material: "Cuarzo",
    description:
      "Superficie uniforme, luminosa y fácil de combinar.",
...

  {
    ...
    material: "Granito",
    description:
      "Alta resistencia y profundidad visual para cocinas y barras.",
...
const SUPABASE_URL =
  "https://ljpdnsjppehslfimefam.supabase.co";

const SUPABASE_PUBLISHABLE_KEY =
  "sb_publishable_mdZUy9cgUegxZY0Zz2B_mQ_dYDQC5IH";
...
// Hacer disponible el cliente para las demás páginas
